...
import com.lucasbarbosa.designpattern.exercises.finance.usecase.RecordedEntriesNotifier;
...
public class FinanceEntrypoint {
  ...
  public static void main(String[] args) {
    ...
    Notifier notifier = new RecordedEntriesNotifier();
    ...
    notifier.addAllListeners(List.of(emailListener, smsListener));
    notifier.notifyContent(content);
